...
import { PicConceptsViewerData } from '../../../interfaces/Actividades';

const PicConceptsViewer: React.FC<PicConceptsViewerData> = ({ concepts }) => {
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Conceptos Clave de Arquitectura PIC</h2>
...
export default PicConceptsViewer;