...
export const ProgramacionMicroprocesador: ActivityDetailSection[] = [
  ...
  },
  {
    ...
    content: 'Practica con ejercicios de código ensamblador para la arquitectura ix86.',
    ...
    data: {
      ...
      exercises: [
        {
          id: 'ej1-hola-mundo',
          title: '1. Mostrar "Hola Mundo"',
          description: 'Muestra un mensaje en pantalla usando interrupciones.',
          code: `
.model small
.stack 100h
.data
...
.code
  ...
  main endp
        ...
        {
          id: 'ej2-suma-numeros',
          title: '2. Suma de dos números',
          description: 'Pide dos números, los suma y muestra el resultado.',
          code: `
.model small
.stack 100h
.data
...
.code
  ...
  main endp
          ...
          `,
          expectedOutput: 'La suma es: [resultado]'
        },
        {
          id: 'ej3-contar-digitos',
          title: '3. Contar el número de dígitos',
          description: 'Cuenta los dígitos de un número ingresado como cadena.',
          code: `
.model small
.stack 100h
.data
...
.code
  ...
  main endp
          ...
          `,
          expectedOutput: 'Numero de digitos: [cantidad]'
        },
        {
          id: 'ej4-invertir-numero',
          title: '4. Invertir un número de 16 bits',
          description: 'Invierte un número ingresado por el usuario.',
          code: `
.model small
.stack 100h
.data
...
.code
  ...
  main endp
          ...
          `,
          expectedOutput: 'Numero invertido: [valor]'
        },
        {
          id: 'ej5-suma-arreglo',
          title: '5. Suma de un arreglo de números',
          description: 'Suma los valores de un arreglo de 10 números.',
          code: `
.model small
.stack 100h
.data
...
.code
  ...
  main endp
          ...
          `,
          expectedOutput: 'La suma del arreglo es: [suma]'
        },
        {
          id: 'ej6-multiplicacion',
          title: '6. Multiplicación de dos números',
          description: 'Multiplica dos números y muestra el resultado.',
          code: `
.model small
.stack 100h
.data
...
.code
  ...
  main endp
          ...
          `,
          expectedOutput: 'El producto es: [producto]'
        }
      ]
    }
  },
  {
    id: 'evaluacion-act4',
    title: 'Evaluación de Ensamblador',
    content: 'Evalúa tus conocimientos sobre la programación en ensamblador.',
    interactiveComponent: 'evaluationAct4',
    data: {
