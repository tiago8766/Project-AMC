...
const AssemblyConceptsViewer: React.FC<AssemblyConceptsViewerData> = ({ concepts }) => { 
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Glosario de Conceptos de Ensamblador ix86</h2>
...
export default AssemblyConceptsViewer;