...
const DroppableText: React.FC<DroppableProps> = ({
  id,
  children,
  hasItem,
  imageUrl,
  ...
  return (
    <div className="flex grow flex-col items-center rounded-lg shadow-md p-4 min-w-[100px]">
      {imageUrl && (
        <img
          src={imageUrl}
          alt="Droppable"
      ...
      <div className="w-full p-5">{text && <p>{text}</p>}</div>
      <div
        ref={setNodeRef}
