const e=[{id:"conceptos-instrucciones",title:"Conceptos Avanzados de Instrucciones",content:"Profundiza en el repertorio de instrucciones de los microcontroladores PIC: transferencia de datos, aritmética, lógica, control de flujo y manipulación de bits.",interactiveComponent:"advancedInstructionsViewer",data:{type:"advancedInstructionsViewer",instructionTypes:[{name:"Repertorio de Instrucciones",description:"Conjunto completo de comandos que un microcontrolador puede ejecutar, escritos en lenguaje ensamblador o código máquina.",examples:[]},{name:"Instrucciones de Transferencia de Datos",description:"Permiten mover datos entre registros, memoria y puertos de E/S.",examples:[{code:"MOV",explanation:"Copia el contenido de una fuente a un destino."},{code:"LD/ST",explanation:"Carga o almacena datos desde/hacia la memoria (conceptos generales)."},{code:"IN/OUT",explanation:"Lee o escribe en un puerto de E/S."}]},{name:"Instrucciones Aritméticas y Lógicas",description:"Realizan operaciones matemáticas y de lógica binaria a nivel de bit.",examples:[{code:"ADD, SUB, INC, DEC",explanation:"Suma, resta, incremento, decremento (Aritméticas)."},{code:"AND, OR, XOR, NOT",explanation:"Operaciones lógicas a nivel de bit."},{code:"CMP",explanation:"Compara dos valores (afecta los flags)."},{code:"CLR",explanation:"Borra el contenido de un registro."}]},{name:"Control de Flujo de Programa",description:"Alteran la secuencia normal de ejecución de instrucciones (ciclos, decisiones, subrutinas).",examples:[{code:"JMP etiqueta",explanation:"Salto incondicional a una dirección específica."},{code:"JZ (Jump if Zero), JC (Jump if Carry), JNZ, JE, JNE",explanation:"Saltos condicionales basados en flags del procesador."}]},{name:"Instrucciones de Bits",description:"Manipulan directamente bits individuales de registros o puertos, crucial para periféricos.",examples:[{code:"SETB",explanation:"Establece un bit en 1."},{code:"CLR",explanation:"Borra un bit."},{code:"CPL",explanation:"Invierte (complementa) un bit."},{code:"JB, JNB",explanation:"Salto si un bit está en 1 o 0."}]}]}},{id:"programacion-perifericos",title:"Programación con Periféricos: Interrupciones y Comunicación",content:"Explora ejemplos prácticos de control de LEDs, lectura de sensores, PWM, y comunicación serial e I2C en microcontroladores PIC.",interactiveComponent:"picPeripheralCodeViewer",data:{type:"picPeripheralCodeViewer",projects:[{id:"led-retardo",title:"1. Encender y Apagar un LED con Retardo",description:"Controla el parpadeo de un LED conectado al pin RC0.",code:`
#include <xc.h>
...
void main(void) {
  ...
  while (1) {
    ...
    _delay_ms(500);     // Retardo de 500 ms
          ...
          `},{id:"boton-led",title:"2. Leer un Botón y Encender un LED",description:"Si se presiona un botón conectado a RA0, enciende un LED en RC0.",code:`
#include <xc.h>
  ...
  while(1) {
    if (PORTAbits.RA0 == 1) { // Si el botón está presionado (nivel alto)
      ...
      PORTCbits.RC0 = 0;      // Apaga el LED
          ...
          `},{id:"adc-led-umbral",title:"3. Medir Voltaje con ADC y Encender LED",description:"Mide un voltaje analógico en RA0. Si supera 2V, enciende un LED en RC0.",code:`
#include <xc.h>
#include <stdint.h>
#define _XTAL_FREQ 8000000 // Frecuencia del oscilador
...
void main(void) {
  ...
  while (1) {
    ...
    _delay_ms(100); // Pequeño retardo
          ...
          `},{id:"pwm-motor",title:"4. PWM para Controlar Velocidad de Motor",description:"Genera una señal PWM con duty cycle del 50% usando CCP1 (RC2).",code:`
#include <xc.h>
#include <stdint.h>
...
void main(void) {
  ...
  while (1) {
    ...
    // Puedes variar CCPR1L y DC1B para cambiar el duty cycle
          ...
          `},{id:"interrupcion-externa",title:"1. Ejemplo con Interrupciones: Botón Activa Interrupción Externa",description:"Cuando se presione un botón conectado a RB0 (INT), se enciende un LED en RC0 por 1 segundo usando una interrupción externa.",code:`
#include <xc.h>
#define _XTAL_FREQ 8000000 // Frecuencia del oscilador
...
void main(void) {
  ...
  while(1) {
    // El microcontrolador puede estar haciendo otra cosa o estar en modo de bajo consumo
          ...
          `},{id:"usart-enviar",title:"2. Ejemplo con USART: Enviar Datos por UART",description:"Envía un texto por el puerto serial continuamente usando el módulo USART del PIC.",code:`
#include <xc.h>
#include <stdint.h>
#define _XTAL_FREQ 8000000 // Frecuencia del oscilador (8 MHz)
...
void main(void) {
  ...
  while (1) {
    ...
    __delay_ms(1000); // Esperar 1 segundo antes de enviar nuevamente
          ...
          `},{id:"mini-proyecto-i2c-uart",title:"Mini Proyecto: Terminal Serial con Sensor I2C (LM75)",description:"Terminal serial que consulta temperatura a un sensor LM75 vía I2C al presionar un botón (interrupción externa) y la envía por UART.",code:`
#include <xc.h>
  ...
  while (1) {
    if (temperatura_pendiente) {
      ...
      UART_Write_Text(buffer);
          ...
          `}]}}];export{e as ProgramacionAvanzadaPic};
